 ...
 * with {@link DataSourceTransactionManager}
...
public class HibernateTransactionManager extends AbstractSynchronousTransactionManager<Connection>
    ...
    protected void doBegin(Object transaction, TransactionDefinition definition) {
        ...
        try {
            ...
            if (getDataSource() != null) {
                ...
                ConnectionHolder conHolder = new ConnectionHolder(getConnection(session));
                if (timeout != TransactionDefinition.TIMEOUT_DEFAULT) {
    ...
    protected void doCleanupAfterCompletion(Object transaction) {
        ...
        if (txObject.isNewSession()) {
            ...
            if (txObject.getSessionHolder().getPreviousFlushMode() != null) {
                session.setFlushMode(txObject.getSessionHolder().getPreviousFlushMode().toJpaFlushMode());
            }
     ...
     * <p>The default implementation calls {@link LogicalConnectionImplementor#manualDisconnect()}.
    ...
    public Connection getConnection() {
        return getConnection(sessionFactory.getCurrentSession());
    }
